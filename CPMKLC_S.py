...
def get_argument_parser():
    ...
    parser.add_argument('--gpu', type=str, default='2',
                        help='GPU to use')
    parser.add_argument('--output', type=str, default='HePy.dzip.comp',
...
def main():
    ...
    FLAGS.temp_dir = 'temp_distillation' + str(FLAGS.k)  + '_' + str(FLAGS.w)
    ...
    if FLAGS.model_catena == "SPuM":  # 根据选择的系列模型更改模型嵌入的参数
        timesteps = 32
        bsdic['hdim1'] = 128
        bsdic['hdim2'] = 128
        bsdic['emb_size'] = 16
